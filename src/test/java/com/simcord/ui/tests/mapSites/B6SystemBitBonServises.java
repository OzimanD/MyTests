...
public class B6SystemBitBonServises extends Methods {
    ...
    public static String BitBonServiceBonpay() throws InterruptedException {
        ClickIconMapSites();
        WebElement element2 = driver.findElement(By.xpath(XpathRoadMap.RoadMapSystemBitBonServiceBonpay));
        element2.click();
        WaitLoadPage();
        waitUntil(XpathRoadMap.RoadMapSystemBitBonServiceBonpayME);
        return GetLink;
    }
...
//        System.out.println(Developers);
        Assert.assertEquals(GetLink, BitBonServiceBonpay, "Pass Test C236432");
    }
