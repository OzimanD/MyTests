...
public class ClikcsSupportFAQ extends Methods {
    ...
    public static boolean FAQ() throws InterruptedException {
        WebElement element2 = driver.findElement(By.xpath(XpathFutter.FutterSupportsFAQ));
        element2.click();
        WaitLoadPage();
        String Link2 = driver.getCurrentUrl();
        boolean res2 = Link2.equals(XpathFutter.s40);
        return res2;
    }

    public static void Result() throws InterruptedException {
        Assert.assertTrue(FAQ(), "Pass Test C236420");
    }
