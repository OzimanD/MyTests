...
public class TestNewsButtonHeader extends Methods {
    //C236411
    //Нажатие на выбранный пункт меню -> открытие соответствующего раздела
    @Test(description = "Tests of Header")
    public static void Check() throws InterruptedException {
        WebElement element = driver.findElement(By.xpath(XpathMainPage.HeaderNews));
        element.click();
        String s1 = "http://stg.bitbon.space/ru/news";
//        Thread.sleep(2000);
        waitUntil(XpathMainPage.HeaderNewsME);
